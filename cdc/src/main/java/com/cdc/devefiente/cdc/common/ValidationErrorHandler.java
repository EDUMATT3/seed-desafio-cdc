...
public class ValidationErrorHandler {
    ...
    public ValidationErrorsResponseDTO handleValidationError(BindException exception) {
    ...
    public ValidationErrorsResponseDTO handleValidationError(HttpMessageNotReadableException exception) {
